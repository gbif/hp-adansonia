...
const publisherKey = 'b32d3b6f-0ae7-4305-a20c-acfa59f66996';

var siteConfig = {
  routes: {
    alwaysUseHrefs: false,
    enabledRoutes: ['occurrenceSearch', 'datasetSearch', 'datasetKey', 'literatureSearch', 'collectionKey'],
  },
  dataset: {
    rootFilter: {
  ...
  occurrence: {
    ...
    availableTableColumns: ['features', 'country', 'stateProvince', 'locality', 'coordinates', 'year', 'eventDate', 'basisOfRecord', 'recordedBy', 'identifiedBy', 'recordNumber', 'catalogNumber', 'collectionCode', 'institutionCode', 'datasetKey'],
